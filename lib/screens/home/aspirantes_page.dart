...
class VacantsList extends StatefulWidget {
  VacantsList({Key? key}) : super(key: key);

  @override
  State<VacantsList> createState() => _searchList();
}

class _searchList extends State<VacantsList> {
